...
interface BreezeTypeShortcutProps {
...
export const BreezeTypeShortcut: React.FC<BreezeTypeShortcutProps> = ({
      ...
      <div className="flex items-center space-x-1">
        {editingShortcutId === shortcutId ? (
          <div
            ...
            className="min-w-[120px] rounded-2xl border border-black/5 bg-blue-500/10 px-3 py-2 text-center text-sm font-semibold text-blue-600 dark:border-white/10 dark:text-blue-500"
          >
            {formatCurrentKeys()}
          </div>
        ) : (
          <div
            className="min-w-[120px] cursor-pointer rounded-2xl border border-black/5 bg-white/55 px-3 py-2 text-center text-sm font-semibold text-zinc-700 shadow-[0_6px_18px_-14px_rgb(0_0_0_/_0.25)] backdrop-blur-2xl transition-all hover:bg-blue-500/10 hover:text-blue-600 dark:border-white/10 dark:bg-zinc-900/55 dark:text-zinc-200 dark:hover:text-blue-500"
