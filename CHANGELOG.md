...
- Prepared the desktop App repository for public GitHub presentation with clearer quick-start, open-source boundary, release/updater, and visual asset guidance.
- Documented that local/open-source builds can enter the app without first-run auth while official production builds may require auth with `VITE_BREEZE_REQUIRE_FIRST_RUN_AUTH=true`.
...
- **Initial release** of the desktop app
