...
#[tauri::command]
#[specta::specta]
pub fn is_voice_activity_active(app: AppHandle) -> bool {
    let audio_manager = app.state::<Arc<AudioRecordingManager>>();
    audio_manager.is_recording() || crate::actions::is_transcribe_action_active()
}

#[tauri::command]
#[specta::specta]
pub fn get_overlay_meter_levels() -> Vec<f32> {
    crate::overlay::latest_levels()
}
